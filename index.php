...
<html>
	...
	<body>
		...
		<div id="header-image" data-role="header" data-theme="<?php echo $theme ?>" data-position="fixed">
		    ...
		    <h1><img src="img/logo-panto.png" alt="LOGO"></h1>
		...
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  	...
		  	<div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
                ...
                <div class="nemanja" data-role="collapsible" data-theme="<?php echo $theme ?>" data-content-theme="<?php echo $theme ?>" data-iconpos="right" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d">

                    <h3>Collection</h3>

                    <a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Ballet Flats</a>

                    <a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">High Hells</a>

                    <a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Wedges</a>
                ...
                <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                    ...
                    <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">About</a></div>

                </div>

                <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">

                    <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Our Stores</a></div>
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					...
					<section id="navigation-menu">
						...
						<ul id="menu" class="menuhide">
							...
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Collection</a></li>

							<li><a href="#page2" data-transition="<?php echo $transitionefect ?>">About</a></li>

                            <li><a href="#page2" data-transition="<?php echo $transitionefect ?>">Our Stores</a></li>
